            ...
            append_tweet_info = ( tweet_result ) => {
                ...
                const
                    ...
                    tweet_info = {
                        ...
                        retweet_id,
                        quoted_tweet_id,
                        quoted_tweet_url : ( ! quoted_tweet_id ) ? null : ( quoted_result?.legacy?.quoted_status_permalink?.expanded ?? `https://x.com/${quoted_result?.core?.user_results?.result?.legacy?.screen_name ?? 'i'}/status/${quoted_tweet_id}` ), //twitter
                    };
